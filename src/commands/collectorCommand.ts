...
export default {
  ...
  builder: (yargs) => {
    return yargs
      ...
      .describe("testssl-extra-args", "An extra argument that will be passed to testssl.sh. Specify multiple times to have multiple arguments.")
      .nargs("testssl-extra-args", 1)
      .string("testssl-extra-args")
